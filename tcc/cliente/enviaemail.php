...
// Usuário da conta
$mail->Username = 'eivacinaetec@gmail.com';
 
// Senha da conta
$mail->Password = 'tccdemerda';
...
// Email do Remetente
$mail->From = 'eivacinaetec@gmail.com';
 
// Nome do Remetente
$mail->FromName = 'grupo tcc';
 
// Endereço do e-mail do destinatário
$mail->addAddress($email);
 
// Assunto do e-mail
$mail->Subject = 'informações de usuário e senha';
 
// Mensagem que vai no corpo do e-mail

$mail->Body = '<p>http://localhost/tcc/cliente/trocaSenha.php?'.$cpf.'</p>';

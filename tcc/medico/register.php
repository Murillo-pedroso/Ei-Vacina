  ...
  <body>
    ...
    <div class="box">
      ...
      <form method="post" action="CodRegister.php">
        ...
        <div class="input-box">
            <input type="password" name="txSenha" maxlength="20" required>
            <label>Password</label>
            
        </div>

         <div class="input-box">
            <input type="password" name="txrepSenha" maxlength="20" required>
            <label>Repeat password</label>
            <input type="submit" name="" value="Submit" onclick="validaCPF()">
        </div>
